...
void dance_carp (qk_tap_dance_state_t *state, void *user_data) {
	switch(state->count){
		...
		break;
		case 9:
		SEND_STRING ("MaruPointerException");
		break;
		case 10:
...
[MDIA] = LAYOUT_ergodox(
  // left hand
  KC_TRNS, POS_1, POS_2, POS_3, POS_4, POS_5, KC_TRNS,
  KC_TRNS, KC_TRNS, KC_TRNS, KC_MS_U, KC_TRNS, KC_TRNS, KC_TRNS,
  KC_TRNS, KC_TRNS, KC_MS_L, KC_MS_D, PLY_FLY, KC_TRNS,
  ...
  // right hand
  KC_TRNS, POS_6, POS_7, POS_8, POS_9, KC_TRNS, KC_TRNS,
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
           KC_TRNS, PLY_FOUL, PLY_K, KC_TRNS, KC_TRNS, KC_MPLY,
